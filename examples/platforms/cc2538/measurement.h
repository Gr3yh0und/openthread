...
#define LED0_ON 		M_GPIO_SET_PIN(GPIO_C_BASE, LED0_MASK)
#define LED0_OFF 		M_GPIO_CLEAR_PIN(GPIO_C_BASE, LED0_MASK)
#define LED1_ON 		M_GPIO_SET_PIN(GPIO_C_BASE, LED1_MASK)
#define LED1_OFF 		M_GPIO_CLEAR_PIN(GPIO_C_BASE, LED1_MASK)
#define LED2_ON 		M_GPIO_SET_PIN(GPIO_C_BASE, LED2_MASK)
#define LED2_OFF 		M_GPIO_CLEAR_PIN(GPIO_C_BASE, LED2_MASK)
#define LED3_ON 		M_GPIO_SET_PIN(GPIO_C_BASE, LED3_MASK)
#define LED3_OFF 		M_GPIO_CLEAR_PIN(GPIO_C_BASE, LED3_MASK)
#define KEY_LEFT_ON 	M_GPIO_SET_PIN(GPIO_C_BASE, KEY_LEFT_MASK)
#define KEY_LEFT_OFF 	M_GPIO_CLEAR_PIN(GPIO_C_BASE, KEY_LEFT_MASK)
#define KEY_RIGHT_ON 	M_GPIO_SET_PIN(GPIO_C_BASE, KEY_RIGHT_MASK)
#define KEY_RIGHT_OFF 	M_GPIO_CLEAR_PIN(GPIO_C_BASE, KEY_RIGHT_MASK)
#define KEY_UP_ON 		M_GPIO_SET_PIN(GPIO_C_BASE, KEY_UP_MASK)
#define KEY_UP_OFF 		M_GPIO_CLEAR_PIN(GPIO_C_BASE, KEY_UP_MASK)
#define KEY_DOWN_ON 	M_GPIO_SET_PIN(GPIO_C_BASE, KEY_DOWN_MASK)
#define KEY_DOWN_OFF 	M_GPIO_CLEAR_PIN(GPIO_C_BASE, KEY_DOWN_MASK)
#define KEY_SELECT_ON 	M_GPIO_SET_PIN(GPIO_A_BASE, KEY_SELECT_MASK)
#define KEY_SELECT_OFF 	M_GPIO_CLEAR_PIN(GPIO_A_BASE, KEY_SELECT_MASK)
#else
#define LED1_ON
#define LED1_OFF
#define LED2_ON
...
#define MEASUREMENT_RECEIVING_ON 	KEY_RIGHT_ON
#define MEASUREMENT_RECEIVING_OFF 	KEY_RIGHT_OFF
...
#define MEASUREMENT_X_ON
#define MEASUREMENT_X_OFF
#endif
