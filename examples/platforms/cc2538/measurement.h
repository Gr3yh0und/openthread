...
#define DIO11_DTR_MASK      M_GPIO_PIN_MASK(2)
#define DIO_B_MASK_ALL      DIO8_MASK + DIO9_PWM0_MASK + DIO10_PWM1_MASK + DIO11_DTR_MASK
#else
...
#define DIO11_ON        M_GPIO_SET_PIN(M_GPIO_B_BASE, DIO11_DTR_MASK)
#define DIO11_OFF       M_GPIO_CLEAR_PIN(M_GPIO_B_BASE, DIO11_DTR_MASK)
#define KEY_LEFT_ON
#define KEY_LEFT_OFF
#define KEY_RIGHT_ON
...
// Combined GPIOs
#define DIOS_ON         DIO0_ON;DIO1_ON;DIO2_ON;DIO3_ON;DIO4_ON;DIO5_ON;DIO6_ON;DIO7_ON;DIO8_ON;DIO9_ON;DIO10_ON;DIO11_ON;
#define DIOS_OFF        DIO0_OFF;DIO1_OFF;DIO2_OFF;DIO3_OFF;DIO4_OFF;DIO5_OFF;DIO6_OFF;DIO7_OFF;DIO8_OFF;DIO9_OFF;DIO10_OFF;DIO11_OFF;
...
#define MEASUREMENT_CCA_ON          NEW_LED1_ON;DIO6_ON;
#define MEASUREMENT_CCA_OFF         NEW_LED1_OFF;DIO6_OFF;
#define MEASUREMENT_TX_ON           NEW_LED2_ON;DIO7_ON;
#define MEASUREMENT_TX_OFF          NEW_LED2_OFF;DIO7_OFF;
#define MEASUREMENT_DTLS_TOTAL_ON   NEW_LED3_ON;DIO8_ON;
#define MEASUREMENT_DTLS_TOTAL_OFF  NEW_LED3_OFF;DIO8_OFF;
#else
// LEDS OFF
#define MEASUREMENT_RX_ON           DIO1_ON
#define MEASUREMENT_RX_OFF          DIO1_OFF
#define MEASUREMENT_CCA_ON          DIO6_ON
#define MEASUREMENT_CCA_OFF         DIO6_OFF
#define MEASUREMENT_TX_ON           DIO7_ON
#define MEASUREMENT_TX_OFF          DIO7_OFF
#define MEASUREMENT_DTLS_TOTAL_ON   DIO8_ON
...
#define MEASUREMENT_DTLS_READ_OFF   KEY_RIGHT_OFF;DIO10_OFF;
#define MEASUREMENT_READ_ON         KEY_UP_ON;DIO11_ON;
#define MEASUREMENT_READ_OFF        KEY_UP_OFF;DIO11_OFF;
